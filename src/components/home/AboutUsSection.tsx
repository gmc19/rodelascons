      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              <img 
                ...
                alt="Rodelas Construction Team" 
                className="rounded-lg shadow-xl z-10 relative"
              />
              <div className="absolute -bottom-6 -right-6 bg-rcs-gold p-6 rounded-lg shadow-lg">
          ...
          >
            ...
            <Link 
              to="/contact" 
              className="inline-flex items-center text-rcs-blue bg-rcs-gold px-6 py-3 rounded-md hover:bg-yellow-400 transition-colors duration-300 font-semibold"
            >
